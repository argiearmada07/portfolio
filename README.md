...
-   **Conversion-First Design**:
    ...
    -   **Mobile-First UX**: Completely responsive layout refined for seamless scanning on all devices.
-   **Advanced Theme System**: Premium Light/Dark mode toggle with automatic persistence.

## 🛠 Tech Stack

-   **Structure**: Semantic HTML5 (SEO Optimized)
-   **Styling**: Vanilla CSS3 (Custom properties, grid/flexbox, zero dependencies)
-   **Logic**: Modern JavaScript (ES6+, Theme persistence, scroll animations)
-   **Typography**: Inter & Outfit (Dual-font design system)
...
├── script.js           # Interactive engine and theme logic
